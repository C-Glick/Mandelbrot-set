...
public class TestBench {
	...
	private static void recordScreen(String filename, String formatname, String codecname, int duration,
	...
	public static void main(String[] args) throws InterruptedException, IOException, AWTException {
		...
		options.addOption(OptionBuilder.withArgName("snaps per second").withLongOpt("snaps").hasArg()
